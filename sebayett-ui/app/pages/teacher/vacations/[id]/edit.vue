...
function validate(): boolean {
  ...
  const order = ['vacation-edit-title', 'vacation-edit-start', 'vacation-edit-end'] as const
...
function handleUpdate() {
  if (!validate()) return
  console.log('Update vacation:', form.value)
...
<template>
  <div class="flex flex-col gap-6">
    <div class="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
      <h1 class="text-[30px] font-bold leading-tight text-gray-900">Edit Vacations</h1>
      <button
        type="button"
    ...
    <div class="rounded-2xl bg-white p-8 shadow-sm">
      <form class="space-y-6" novalidate @submit.prevent="handleUpdate">
        <div class="space-y-2">
          <label for="vacation-edit-title" class="mb-2 block text-sm font-bold text-gray-900">Vacations Title:</label>
          <input
            id="vacation-edit-title"
            v-model="form.title"
            type="text"
            ...
            :aria-describedby="errors.title ? 'vacation-edit-title-error' : undefined"
          >
          <p
            v-if="errors.title"
            id="vacation-edit-title-error"
            role="alert"
        ...
        <DateRangePicker
          ...
          start-id="vacation-edit-start"
          end-id="vacation-edit-end"
