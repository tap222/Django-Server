...
const { data: event } = await useAsyncData(`student-event-detail-${eventId}`, () => eventService.getById(eventId))
      ...
      <div class="rounded-2xl bg-white p-8 shadow-sm">
        <div class="flex flex-col gap-8 lg:flex-row">
          ...
          <div class="flex-1 space-y-6">
            ...
            <!-- Action Buttons (Student specific: maybe Join or just Status) -->
            <div class="mt-8 flex flex-wrap items-center gap-3">
              <div
                :class="[
                  'inline-flex w-[240px] items-center justify-center rounded-lg px-6 py-2.5 text-sm font-bold border',
